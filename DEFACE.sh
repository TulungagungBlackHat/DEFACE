...
cyan="\033[36;1m"
white="\033[39;1m"
figlet -f smshadow "[TBH]•Team"
echo $indigo
date
echo $purple"___________________________________________________"
echo $cyan" ["$red"+"$cyan"]Author by	: [TBH]•Team "
echo $cyan" ["$red"+"$cyan"]Team        : Tulungagung Black Hat	"
echo $cyan" ["$red"+"$cyan"]Github	: https://github.com/TulungagungBlackHat"
echo $cyan" ["$white"NOTE : simpan script di memory internal !!!!! "$cyan"]"
echo $purple"___________________________________________________"
echo $red"	~"$cyan"{"$white"A"$cyan"}"$white".Deface WEBSITE"$cyan"		{"$white"Q"$cyan"}"$white"Quit "
echo $red"	~"$cyan"{"$white"B"$cyan"}"$white".Takescript COLONG SC"$cyan"		{"$white"I"$cyan"}"$white"Info "
...
echo $purple"___________________________________________________"
echo $white "╭─"$green"AMR@ROOTlocalhost"$cyan" ~/[TBH]•Team"$white
read -p " ╰─$ "  apaan

if [ $apaan = "A" ] || [ $apaan = "a" ]
then
figlet -f shadow Deface
echo $green "Masukan Targetnya cok!!!! "
echo $white "╭─"$green"AMR@ROOTlocalhost"$cyan" ~/[TBH]•Team"$white
read -p " ╰─$ "  target
...
echo $white "╭─"$green"AMR@ROOTlocalhost"$cyan" ~/TulungagungBlackHat"$white
read -p " ╰─$ " target10
...
echo $white "╭─"$green"AMR@ROOTlocalhost"$cyan" ~/AOCsystem"$white
read -p " ╰─$ " target16
...
echo $green"AUTHOR : [TBH]•Team	"
echo $purple"GITHUB : https://github.com/TulungagungBlackhat"
echo $yellow"		  THANKS TO : "
echo $cyan"[+] Tulungagung Black Hat"
echo $red"################# INFO ####################"
echo $indigo"__________________________________________"
echo $cyan"["$yellow"B"$cyan"]"$white"back "$cyan"["$yellow"Q"$cyan"]"$white"Quit"
read -p "[B/Q] " back
